...
from .utils import Timer, define_flags_with_default, set_random_seed, print_flags, get_user_flags, prefix_metrics, load_sac
...
def main(argv):
    ...
    assert(FLAGS.sac_path != '', 'SAC load path must provided.')
    sac = load_sac(FLAGS.sac_path)
